                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{route('register')}}">
                                            <div class="form-group">
                                                <input type="text" required="" name="name" placeholder="Name" :value="old('name')" require autofocus autocomplete="name">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input required="" type="password" name="password" placeholder="Confirm password" require autocomplete="new-password">
                                            </div>
